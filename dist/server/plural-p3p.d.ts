import { CaptureOptions, CaptureResult, ChallengeResult, ChargeOptions, CreateMandateOptions, Mandate, PluralSellerConfig, ReceiptContext, ReceiptData, VerificationResult } from "../types";
import { ApiClient } from "./api-client";
import { CaptureClient } from "./capture-client";
import { ChallengeGenerator } from "./challenge-generator";
import { CredentialVerifier } from "./credential-verifier";
export declare class PluralP3PInstance {
...
export declare class PluralP3P {
